...
import java.util.*; //import scanner
    ...
    public class CharlieDoernWeatherAnalysis2 {
        ...
        public static void getover(double avg, int[] temps) { //method to get the days over the avg
            ...
            System.out.println(""); //adds to blank lines for spacing
            System.out.println("");
            System.out.println("Temperatures: "+ Arrays.toString(temps)); // printing out the array
           Arrays.sort(temps); //sorts the array from smallest to largest
            System.out.println("Two coldest days: " + temps[0] + ", " + temps[1]); //print mins, first and second value are the two smallest after sorting
            System.out.print("Two hottest days: "+ temps[temps.length-1] +", " + temps[temps.length-2]); // print maxs, last and second to last are the two largest after sorting
        }
